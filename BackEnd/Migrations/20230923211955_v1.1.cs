        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CuestonarioId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Pregunta", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Pregunta_Cuestionario_CuestonarioId",
                        column: x => x.CuestonarioId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pregunta_CuestonarioId",
                table: "Pregunta",
                column: "CuestonarioId");
